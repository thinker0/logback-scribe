...
public class Scribe {
  ...
  public interface Iface extends com.facebook.fb303.FacebookService.Iface {
    ...
    public ResultCode Log(List<scribe.thrift.LogEntry> messages) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends com.facebook.fb303.FacebookService .AsyncIface {

    public void Log(List<scribe.thrift.LogEntry> messages, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.Log_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends com.facebook.fb303.FacebookService.Client implements Iface {
    ...
    public void send_Log(List<scribe.thrift.LogEntry> messages) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends com.facebook.fb303.FacebookService.AsyncClient implements AsyncIface {
    ...
    public void Log(List<scribe.thrift.LogEntry> messages, org.apache.thrift.async.AsyncMethodCallback<Log_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class Log_call extends org.apache.thrift.async.TAsyncMethodCall {
      private List<scribe.thrift.LogEntry> messages;
      public Log_call(List<scribe.thrift.LogEntry> messages, org.apache.thrift.async.AsyncMethodCallback<Log_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Log_args implements org.apache.thrift.TBase<Log_args, Log_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public List<scribe.thrift.LogEntry> messages; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.MESSAGES, new org.apache.thrift.meta_data.FieldMetaData("messages", org.apache.thrift.TFieldRequirementType.DEFAULT,
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST,
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, scribe.thrift.LogEntry.class))));
    ...
    public Log_args(
      List<scribe.thrift.LogEntry> messages)
    {
      this();
      this.messages = messages;
    }
    ...
    public Log_args(Log_args other) {
      if (other.isSetMessages()) {
        List<scribe.thrift.LogEntry> __this__messages = new ArrayList<scribe.thrift.LogEntry>();
        for (scribe.thrift.LogEntry other_element : other.messages) {
          __this__messages.add(new scribe.thrift.LogEntry(other_element));
        }
    ...
    public void addToMessages(scribe.thrift.LogEntry elem) {
      if (this.messages == null) {
        this.messages = new ArrayList<scribe.thrift.LogEntry>();
      }
      this.messages.add(elem);
    }

    public List<scribe.thrift.LogEntry> getMessages() {
      return this.messages;
    }

    public Log_args setMessages(List<scribe.thrift.LogEntry> messages) {
      this.messages = messages;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case MESSAGES:
        if (value == null) {
          ...
          setMessages((List<scribe.thrift.LogEntry>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.messages = new ArrayList<scribe.thrift.LogEntry>(_list0.size);
                  for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                  {
                    scribe.thrift.LogEntry _elem2; // required
                    _elem2 = new scribe.thrift.LogEntry();
                    _elem2.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, Log_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.messages != null) {
          oprot.writeFieldBegin(MESSAGES_FIELD_DESC);
          {
            ...
            for (scribe.thrift.LogEntry _iter3 : struct.messages)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetMessages()) {
          {
            ...
            for (scribe.thrift.LogEntry _iter4 : struct.messages)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.messages = new ArrayList<scribe.thrift.LogEntry>(_list5.size);
            for (int _i6 = 0; _i6 < _list5.size; ++_i6)
            {
              scribe.thrift.LogEntry _elem7; // required
              _elem7 = new LogEntry();
              _elem7.read(iprot);
